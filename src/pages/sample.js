...
function App() {
  ...
  const getGreeting = async () => {
    ...
    const result = await factoryContract.getDeployedcampaigns();
    setMsg(result);
  };
          ...
          <>
            <Uik.Container vertical className="container">
              ...
              <Uik.Text
                ...
                text={
                  <>
                    ...
                    <span>
                      {" "}
                      Reef's official component library to help you make
                      beautiful dapps with ease
                    </span>
                  </>
                }
              />
              <Uik.Text
                ...
                text={
                  <>
                    ...
                    <span>
                      {" "}
                      Implements a web3 provider which can interact with the
                      Reef chain EVM.
                    </span>
                  </>
                }
              ...
              <Uik.Text
                ...
                text={
                  <>
                    ...
                    <span>
                      {" "}
                      Create React App is the best way to start building a new
              ...
              <Uik.Text
                ...
                text={
                  <>
                    ...
                    <span>
                      {" "}
                      Craco helps you leverage the power of webpack and babel
                      configurations without ejecting your CRA template
                    </span>
                  </>
                }
              />
              ...
              <Uik.Text
                text={
                  <>
                    Click the <Uik.Tag>Connect Wallet</Uik.Tag> button to get
                    started 🚀
                  </>
                }
                type="light"
