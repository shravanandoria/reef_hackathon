          ...
          <CardGroup className="cardDesign">
            <Card className="cardDiv" style={{ margin: "2px 10px" }}>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Hi, We are looking for a developer to integrate web3.js
                  library to connect to a smart contract. This would be an HMTL
                  web page requesting user payment in USDT or Reef, user will
                  initiate payment from their wallet and coins will be
            ...
            <Card className="cardDiv" style={{ margin: "2px 10px" }}>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  ...
                  freelancer with good experience, need this website done very
                  quickly and in best way
                </Card.Text>
                <Uik.Button
                  fill
                  text="View Project"
            ...
            <Card className="cardDiv" style={{ margin: "2px 10px" }}>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Hello, we are a low-budget startup We want to create a USDT to
                  USD (FIAT) exchange for the local market. The website should
                  be written in React/Next.js (front) The idea is simple, we
                  need a landing page where the course will be calculated easily
                  ( USD- GEL course)
                </Card.Text>
                <Uik.Button
                  fill
