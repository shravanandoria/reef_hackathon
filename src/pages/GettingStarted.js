                ...
                <Uik.Text
                    ...
                    text={
                        <>
                            ...
                            <span>
                                {" "}
                                Create a project request if you are a user
                            </span>
                        </>
                    }
                />
                ...
                <Uik.Text
                    ...
                    text={
                        <>
                            ...
                            <span>
                                {" "}
                                If you are an user looking for a direct freelancers just explore this page
                            </span>
                        </>
                    }
                />
                ...
                <Uik.Text
                    ...
                    text={
                        <>
                            <span>
                                {" "}
                                Quicklance is the first decentralized platform for freelancers when they can find projects <br /> and work on them safely and get payments securly.
                            </span>
                        </>
                    }
                />
